  ...
  <div class="wrapper ">
    ...
    <div class="main-panel" id="main-panel">
      ...
      <div class="panel-header panel-header-sm">
       <h1 style="color:white;text-align:center">Suppliers list</h1>
      </div>
      ...
      <div class="content">
        ...
        <table class="table table-dark">
            ...
            <tbody>
                ...
                <td>{{ $supplier->plantname }}</td>
                


                <th><img src="{{ asset('uploads/supplier/' . $supplier->image) }}"width="200px;" heigth="200px;" alt="Image"></th>
                <th><a href="/viewsupplier/{{ $supplier->id }}" class="btn btn-warning">view</a></th>


              @if($supplier->confirm == 1)
                <th><button class="btn btn-success">mesaage sent</buttonu></th>
              @else
              <th><button class="btn btn-warning">mesaage not sent</buttonu></th>
              @endif
                <th><a href="/confirm/{{ $supplier->id }}" class="btn btn-info">send confirmation</a></th>
                <th><a href="/deleteimage/{{ $supplier->id }}" class="btn btn-danger" onclick="return confirm('are you sure?')">delete</a></th>
