  ...
  <div class="wrapper ">
    ...
    <div class="main-panel" id="main-panel">
      ...
      <div class="panel-header panel-header-sm">
       <h1 style="color:white;text-align:center">Delivery Costs</h1>
      </div>
        ...
        <div class="content">
            ...
            <form action="/admin/addcity" method="post">
                {{ csrf_field() }}
                Home town <br>
                <input type="text" name="town" id="" class="form-control" required>
                ...
                Price <br>
                <input type="text" name="cost" id="" class="form-control" required>
                @if ($errors->has('cost'))
                <span class="help-block">
            ...
            <table class="table table-default">
                ...
                <tbody>
                    @foreach ($deliveryData as $item)
                        <tr>
                            <td>{{ $item->homeTown }}</td>
                            <td>{{ $item->delivery_cost }}.00</td>
                            <td> <a href="/admin/remove_city/{{ $item->id }}"> Delete<i class="fa fa-trash-alt" style="font-size:18px;"></i></a></td>
                        </tr>
                    @endforeach
