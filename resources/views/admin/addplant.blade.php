    ...
    <div class="container">
      ...
      <form action="/storeitem" method="POST" enctype="multipart/form-data">
        ...
        <div class="row form-group{{ $errors->has('plantname') ? ' has-error' : '' }}" >
          ...
          <div class="col-75">
            <input type="text" id="fname" name="plantname" value=""> 
        ...
        <div class="row form-group{{ $errors->has('price') ? ' has-error' : '' }}">
            ...
            <div class="col-75">
              <input type="number" id="fname" name="price" value="" >
          ...
          <div class="row form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
            ...
            <div class="col-75">
              <input type="number" id="fname" name="amount" value="" >
          ...
          <div class="row form-group{{ $errors->has('fertilizer') ? ' has-error' : '' }}">
            ...
            <div class="col-75">
              <input type="text" id="fname" name="fertilizer" value="" >
          ...
          <div class="row form-group{{ $errors->has('sproutingtime') ? ' has-error' : '' }}" >
            ...
            <div class="col-75">
              <input type="text" id="fname" name="sproutingtime" value=""> 
