  ...
  <div class="wrapper ">
    ...
    <div class="main-panel" id="main-panel">
      ...
      <div class="panel-header panel-header-sm">
       <h1 style="color:white;text-align:center">Upadate your site</h1>
      </div>
        ...
        <br>
            ...
            <div class="row">
                <div class="col-sm-12" style="text-align: center;font-size: 20px;">
                   ...
                   <label style="margin-right:3%;">manage image slider :</label><a href="/imageslider" class="btn btn-info">Manage</a>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12" style="text-align: center;font-size: 20px;">
                   ...
                   <label style="margin-right:5%;">manage paragraph :</label><a href="/paragraph" class="btn btn-info">Manage</a>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12" style="text-align: center;font-size: 20px;">
                   ...
                   <label style="margin-right:7%;">manage contact :</label><a href="/contact" class="btn btn-info">Manage</a>
                </div>
