  ...
  <div class="wrapper ">
    ...
    <div class="main-panel" id="main-panel">
      ...
      <div class="panel-header panel-header-sm">
       <h1 style="color:white;text-align:center">Manage contact</h1>
      </div>
      ...
      <div class="content">
        ...
        <form method="POST" action="/savecontact" enctype="multipart/form-data" style="border:1px solid black;">
                        {{csrf_field()}}
        ...
        <div class="row">
            ...
            <div class="col-sm-6" style="text-align: center;font-size: 20px;">
                ...
                <lable>Hot Line :</lable>                   
         
            </div>         
        
            <div class="col-sm-6" style="text-align: center;">
            
                <input type="number" style="width: 85%;" name="hotline" value="{{$contacts->hotline}}" required>
        ...
        <div class="row">
            ...
            <div class="col-sm-6" style="text-align: center;">
                ...
                <input type="email" style="width: 85%;" name="email" value="{{$contacts->email}}" required>
        ...
        <div class="row">
            ...
            <input type="number" style="width:85%" name="fax" value="{{$contacts->fax}}" required>
