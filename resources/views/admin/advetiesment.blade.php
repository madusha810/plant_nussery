  ...
  <div class="wrapper ">
    ...
    <div class="main-panel" id="main-panel">
      ...
      <div class="panel-header panel-header-sm">
       <h1 style="color:white;text-align:center">POST ADVERTISEMENT</h1>
      </div>
    ...
    <br>
      ...
      <form method="POST" action="/savenewadd" enctype="multipart/form-data">
                        {{csrf_field()}}

               
            
                  <div class="col-sm-25">  
                  <lable><b>Advertiesment :</b></lable> 
                  </div>
                  <br>
                  <div class="col-sm-75">
        ...
        <br>
                ...
                <table class="table table-dark" style="text-align:center;">
                   ...
                   <tr>
                       ...
                       <td><img src="{{asset('uploads/advertiement/'.$adds->image)}}" width="100px" height="100px" alt="image"></td>
                       <td>{{Carbon\Carbon::now()->diffInDays($adds->date) . ' more days'}}</td>
                       <td><a href="/editadd/{{$adds->id}}" class="btn btn-info" onclick="return confirm('are you sure?')">edit</a></td>
                       <td><a href="/deleteadd/{{$adds->id}}" class="btn btn-danger" onclick="return confirm('are you sure?')">delete</a></td>
