  ...
  <div class="wrapper ">
    ...
    <div class="main-panel" id="main-panel">
      ...
      <div class="panel-header panel-header-sm">
       <h1 style="color:white;text-align:center">EDIT ADVERTISEMENT</h1>
      </div>
      ...
      <div class="content">
        ...
        <form method="POST" action="/saveadd" enctype="multipart/form-data">
                        {{csrf_field()}}
                  ...
                  <br>
                  <div class="col-sm-75">
                  <input type="date" class="form-control" name="date" value="{{$add->date}}" placeholder="" >
                  </div>
