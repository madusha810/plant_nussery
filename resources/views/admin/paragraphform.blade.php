  ...
  <div class="wrapper ">
    ...
    <div class="main-panel" id="main-panel">
      ...
      <div class="panel-header panel-header-sm">
       <h1 style="color:white;text-align:center">Edit paragraph</h1>
      </div>
      <br>
      <br>
      <div class="content">
        ...
        <form method="POST" action="/saveparagaph" enctype="multipart/form-data">
                        {{csrf_field()}}
        ...
        <div class="row">
            ...
            <div class="col-sm-6" style="text-align: center;font-size: 20px;">
                ...
                <lable>first paragraph :</lable>                   
         
            </div>         
        
            <div class="col-sm-6" style="text-align: center;">
            
                <textarea style="width: 80%;height: 100%;" name="firstparagraph" required>{{$infos->firstparagraph}}</textarea>
        ...
        <div class="row">
            ...
            <div class="col-sm-6" style="text-align: center;font-size: 20px;">
                ...
                <lable>second paragraph :</lable>                   
         
            </div>         
        
            <div class="col-sm-6" style="text-align: center;">
            
                <textarea style="width: 80%;height: 100%;" name="secondparagraph" required>{{$infos->secondparagraph}}</textarea>
