      ...
      <div class="content">
        ...
        <br>
                <table class="table table-default">
                  ...
                  <tr>
                    <td>{{$users->name}}</td>
                    <td><a href="/detail/{{$users->id}}" class="btn btn-info">view</a></td>
                    <td>
                      @if($users->usertype)
                      <a href="/asadmin/{{$users->id}}" class="btn btn-success" onclick="return confirm('are you sure name as admin?')">name as admin</a>
                      @else
                      <a href="/asadmin/{{$users->id}}" class="btn btn-danger" onclick="return confirm('are you sure remove from admin?')">remove from admin</a>
                      @endif
                    </td>
                    <td><a href="/remove/{{$users->id}}" class="btn btn-warning" onclick="return confirm('are you sure to delete this user?')"><img src="https://img.icons8.com/material/24/000000/delete-forever--v1.png">delete</a>
                    </td>
                  </tr>
                  @endforeach
